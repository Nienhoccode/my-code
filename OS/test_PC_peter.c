...
int turn; // Biến xác định đến lượt ai (0 là Producer, 1 là Consumer)
bool flag[2]; // Mảng đánh dấu mong muốn vào vùng găng.
                // flag[0] = true nghĩa là Producer muốn vào.
                // flag[1] = true nghĩa là Consumer muốn vào.
